...
pub enum Event {
    ...
    Run,
    Pause,
    /// Set the emulation speed as a percentage of real time (100 = normal), and
    /// whether to mute audio while it is above real time. The frontend uses this
    /// for hold-to-fast-forward.
    SetSpeed { percent: u16, mute: bool },
