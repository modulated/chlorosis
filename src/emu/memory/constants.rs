...
pub const CARTRIGE_0_START: u16 = 0x0000;
pub const CARTRIGE_0_END: u16 = 0x3FFF;
pub const CARTRIGE_1_START: u16 = 0x4000;
pub const CARTRIGE_1_END: u16 = 0x7FFF;
...
pub const CARTRIGE_BANK_SIZE: usize = 0x4000; // 16 KB
